...
// skipping Fuzz_Nosy_WethFilterer_WatchApproval__ because parameters include func, chan, or unsupported interface: chan<- *github.com/Layr-Labs/eigenda/indexer/test/accumulator/bindings.WethApproval

// skipping Fuzz_Nosy_WethFilterer_WatchDeposit__ because parameters include func, chan, or unsupported interface: chan<- *github.com/Layr-Labs/eigenda/indexer/test/accumulator/bindings.WethDeposit

// skipping Fuzz_Nosy_WethFilterer_WatchTransfer__ because parameters include func, chan, or unsupported interface: chan<- *github.com/Layr-Labs/eigenda/indexer/test/accumulator/bindings.WethTransfer

// skipping Fuzz_Nosy_WethFilterer_WatchWithdrawal__ because parameters include func, chan, or unsupported interface: chan<- *github.com/Layr-Labs/eigenda/indexer/test/accumulator/bindings.WethWithdrawal
